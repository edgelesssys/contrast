...
For details, visit the [Contrast documentation](https://docs.edgeless.systems/contrast/1.9/basics/security-benefits).
...
For details, visit the [Contrast documentation](https://docs.edgeless.systems/contrast/1.9/basics/security-benefits#personas-in-a-contrast-deployment).
...
For details, visit the [Contrast documentation](https://docs.edgeless.systems/contrast/1.9/components/overview).
...
For details, visit the [Contrast documentation](https://docs.edgeless.systems/contrast/1.9/components/policies).
...
For details, see the [Contrast documentation](https://docs.edgeless.systems/contrast/1.9/architecture/attestation).
...
For details, see the [Contrast documentation](https://docs.edgeless.systems/contrast/1.9/architecture/certificates).
...
For details, see the [Contrast documentation](https://docs.edgeless.systems/contrast/1.9/components/service-mesh#configuring-the-proxy).
...
Managed Kubernetes like AKS offers some CoCo-enabled node pools with nested virtualization, as nodes in case of AKS aren't bare-metal machines but already virtualized. See the [Contrast documentation](https://docs.edgeless.systems/contrast/1.9/getting-started/cluster-setup) for details.

Additionally, some [initial adjustments](https://docs.edgeless.systems/contrast/1.9/getting-started/bare-metal?vendor=amd) need to be made to the worker nodes.
...
For details, visit the [Contrast documentation](https://docs.edgeless.systems/contrast/1.9/architecture/snp).
...
You can follow the [Confidential emoji voting tutorial](https://docs.edgeless.systems/contrast/1.9/examples/emojivoto) as an example of a practical deployment workflow.
