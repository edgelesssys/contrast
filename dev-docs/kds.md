...
The go-sev-guest library checks the signature of both VCEK and CRL.

The CRL has an expiration date included. The go-sev-guest library will check the CRL isn't expired during the verification on client side.
