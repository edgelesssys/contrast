...
func (h *History) WalkTransitions(transitionRef [HashSize]byte, consume func([HashSize]byte, *Transition) error) error {
	for transitionRef != [HashSize]byte{} {
		transition, err := h.GetTransition(transitionRef)
		if err != nil {
