...
```sh
kubectl apply -f https://github.com/edgelesssys/contrast/releases/download/v1.20.0/node-installer-target-config-k3s.yml
```
...
```sh
kubectl apply -f https://github.com/edgelesssys/contrast/releases/download/v1.20.0/node-installer-target-config-rke2.yml
```
