...
```sh
kubectl apply -f https://github.com/edgelesssys/contrast/releases/download/v1.18.0/runtime-metal-qemu-snp-gpu.yml
```
</TabItem>
...
```sh
kubectl apply -f https://github.com/edgelesssys/contrast/releases/download/v1.18.0/runtime-metal-qemu-tdx-gpu.yml
```
</TabItem>
</Tabs>
