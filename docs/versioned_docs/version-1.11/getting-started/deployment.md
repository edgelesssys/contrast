...
```sh
curl -fLO https://github.com/edgelesssys/contrast/releases/download/v1.11.0/emojivoto-demo.yml --create-dirs --output-dir resources
```
...
```sh
curl -fLO https://github.com/edgelesssys/contrast/releases/download/v1.11.0/coordinator.yml --output-dir resources
```
