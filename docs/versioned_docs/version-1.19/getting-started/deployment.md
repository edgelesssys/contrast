...
```sh
curl -fLO https://github.com/edgelesssys/contrast/releases/download/v1.19.0/emojivoto-demo.yml --create-dirs --output-dir resources
```
...
```sh
kubectl apply -f https://github.com/edgelesssys/contrast/releases/download/v1.19.0/runtime-metal-qemu-snp.yml
```
</TabItem>
<TabItem value="metal-qemu-tdx" label="Bare metal (TDX)">
```sh
kubectl apply -f https://github.com/edgelesssys/contrast/releases/download/v1.19.0/runtime-metal-qemu-tdx.yml
```
</TabItem>
</Tabs>
...
```sh
curl -fLO https://github.com/edgelesssys/contrast/releases/download/v1.19.0/coordinator.yml --output-dir resources
```
