...
The pod level memory requests and limits are then determined by accounting for the minimum required memory to pull and decompress the images and the specified container limits.
