...
curl -fLO https://github.com/edgelesssys/contrast/releases/download/v1.22.0/runtime-metal-qemu-snp.yml --output-dir resources/runtime
curl -fLO https://github.com/edgelesssys/contrast/releases/download/v1.22.0/runtime-metal-qemu-tdx.yml --output-dir resources/runtime
```
