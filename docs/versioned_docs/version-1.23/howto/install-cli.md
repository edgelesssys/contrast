...
```bash
curl --proto '=https' --tlsv1.2 -fLo contrast https://github.com/edgelesssys/contrast/releases/download/v1.23.0/contrast-x86_64-linux
...
```bash
curl --proto '=https' --tlsv1.2 -fLo contrast https://github.com/edgelesssys/contrast/releases/download/v1.23.0/contrast-aarch64-darwin
sudo install contrast /usr/local/bin/contrast
```
