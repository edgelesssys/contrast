...
Collecting logs is a helpful first step in diagnosing and resolving deployment
issues.
...
The Contrast CLI, Coordinator, and Initializer can all be configured to emit
additional logs.
