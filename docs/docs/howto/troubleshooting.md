...
The output shows that there are four Contrast runtime classes installed.
...
Check the output for the section with the platform you are using, for example or `Metal-QEMU-SNP`.
