...
Review the [security considerations](../hardening.md) and the [certificates](../../architecture/components/service-mesh.md#public-key-infrastructure) section for writing secure Contrast application.
