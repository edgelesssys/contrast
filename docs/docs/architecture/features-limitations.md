...
- **Port forwarding**: This feature [isn't yet supported by Kata Containers](https://github.com/kata-containers/kata-containers/issues/1693). You can [deploy a port-forwarder](../howto/workload-deployment/connect-to-coordinator.md) as a workaround.
