...
buildGoModule (finalAttrs: {
  ...
  src = applyPatches {
    ...
    patches = [
      ...
      ./0018-misc-use-compressed-policy.patch
      ...
      ./0019-agent-use-separate-unix-socket-for-image-pulling.patch
      ...
      # The patch should become unnecessary once the RFC for loose coupling of agents and guest components is implemented:
      # https://github.com/kata-containers/kata-containers/issues/11532
      ./0020-agent-use-custom-implementation-for-secure-mounting.patch
      ...
      ./0021-genpolicy-don-t-apply-Nydus-workaround.patch
    ];
  };
