...
buildGoModule rec {
  ...
  src = applyPatches {
    ...
    patches = [
      ...
      ./0003-genpolicy-enable-sysctl-checks.patch
      # Fixes https://github.com/kata-containers/kata-containers/issues/10065.
      # TODO(burgerdev): backport
      ./0004-genpolicy-read-bundle-id-from-rootfs.patch
      ...
      ./0005-genpolicy-regex-check-contrast-specific-layer-src-pr.patch
      ...
      # fields of the spec.
      ./0006-genpolicy-rules-remove-check-for-OCI-version.patch
      ...
      ./0007-genpolicy-settings-change-cpath-for-Nydus-guest-pull.patch
      # Implements ideas from https://github.com/kata-containers/kata-containers/issues/10088.
      # TODO(burgerdev): backport
      ./0008-genpolicy-allow-image_guest_pull.patch
      ...
      ./0009-runtime-agent-mounts-Mount-configfs-into-the-contain.patch
      # The following two patches update the image-rs and oci-distribution version.
      # TODO(burgerdev): backport
      ./0010-genpolicy-bump-oci-distribution-to-v0.12.0.patch
      ...
      ./0011-genpolicy-support-mount-propagation-and-ro-mounts.patch
      ...
      # our Nix packaging.
      ./0012-tools-don-t-clean-build-root-when-generating-rootfs.patch
      ...
      ./0013-runtime-allow-initrd-AND-image-to-be-set.patch
      ...
      ./0014-genpolicy-do-not-log-policy-annotation-in-debug.patch
      ...
      ./0015-genpolicy-allow-non-watchable-ConfigMaps.patch
      ...
      ./0016-genpolicy-support-guest-hooks.patch
      ...
      ./0017-genpolicy-support-dynamic-annotations.patch
      ...
      ./0018-agent-clear-log-pipes-if-denied-by-policy.patch
