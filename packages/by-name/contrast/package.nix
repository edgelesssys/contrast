...
buildGoModule (finalAttrs: {
  ...
  proxyVendor = true;
  vendorHash = "sha256-gSuCWGpr1TqYnXmKbRgxa4yHk6yZvO3jHDzJOMiJaW4=";
  ...
  prePatch = ''
    install -D ${lib.getExe contrastPkgs.contrastPkgsStatic.kata.genpolicy} cli/genpolicy/assets/genpolicy-kata
