...
func newTestManifestSNP() *Manifest {
	return &Manifest{
		...
		WorkloadOwnerPubKeys:  []HexString{"3076301006072a8648ce3d020106052b8104002203620004a8815dd996be514de4ebff51d6757aa79dd56ab8711cb3be91bf1aea7dcfdd5f6f00e5d5cbc5afdfe671ef8c508f2fdea68f5cd1c27c31df10af267d05c2bf8c12859f19ebc4bcaea428f625f7111c3ff68f784522d094c8442f43e61106521e"},
...
func TestValidate(t *testing.T) {
	testCases := map[string]struct {
		...
		"invalid workload owner key": {
			m: newTestManifestSNP(),
			mutate: func(m *Manifest) {
				m.WorkloadOwnerPubKeys = []HexString{"invalid"}
			},
			wantErr: true,
		},
