...
func UnmarshalApplyConfigurations(data []byte) ([]any, error) {
	...
	applyConfigs, err := UnstructuredToApplyConfigurations(objs)
	if err != nil {
		return nil, fmt.Errorf("converting to apply configurations: %w", err)
	}
	return applyConfigs, nil
}

// UnstructuredToApplyConfigurations converts a list of unstructured resources into a list of ApplyConfigurations.
func UnstructuredToApplyConfigurations(objs []*unstructured.Unstructured) ([]any, error) {
	var result []any
