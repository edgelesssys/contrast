...
var (
	//go:embed testdata/runtime-rs/expected-configuration-qemu-snp.toml
	expectedConfMetalQEMUSNP []byte
	//go:embed testdata/runtime-rs/expected-configuration-qemu-tdx.toml
	expectedConfMetalQEMUTDX []byte
	//go:embed testdata/runtime-rs/expected-configuration-qemu-snp-gpu.toml
