...
func (x *SecureMountRequest) Reset() {
	*x = SecureMountRequest{}
	mi := &file_imagestore_proto_msgTypes[0]
...
func (*SecureMountRequest) Descriptor() ([]byte, []int) {
	return file_imagestore_proto_rawDescGZIP(), []int{0}
}
...
func (x *SecureMountResponse) Reset() {
	*x = SecureMountResponse{}
	mi := &file_imagestore_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_imagestore_proto_rawDesc = "" +
	...
	"\vSecureMount\x12\x17.api.SecureMountRequest\x1a\x18.api.SecureMountResponse\"\x00B9Z7github.com/edgelesssys/contrast/imagestore/internal/apib\x06proto3"

var (
	file_imagestore_proto_rawDescOnce sync.Once
	file_imagestore_proto_rawDescData []byte
)

func file_imagestore_proto_rawDescGZIP() []byte {
	file_imagestore_proto_rawDescOnce.Do(func() {
		file_imagestore_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_imagestore_proto_rawDesc), len(file_imagestore_proto_rawDesc)))
	})
	return file_imagestore_proto_rawDescData
}
...
func init() { file_imagestore_proto_init() }
func file_imagestore_proto_init() {
	if File_imagestore_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_imagestore_proto_rawDesc), len(file_imagestore_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_imagestore_proto_goTypes,
		DependencyIndexes: file_imagestore_proto_depIdxs,
		MessageInfos:      file_imagestore_proto_msgTypes,
	}.Build()
	File_imagestore_proto = out.File
	file_imagestore_proto_goTypes = nil
	file_imagestore_proto_depIdxs = nil
}
