...
print(R.xy()[0])
print(R.xy()[1])
print(E.is_on_curve(R.xy()[0], R.xy()[1]))

#
# Generate a random s
#
s = 1      # is used in point multiplication, thus upper bound n
...
h = 77492214967865460963471699751820070564084647936440628989923671088450960649501

Q = (s*R - h*G)  *  ZZ( 1 / Fn(r) )

assert Q == (s*R *  ZZ( 1 / Fn(r) ) - h*G *  ZZ( 1 / Fn(r) ))
print("left:", s*R *  ZZ( 1 / Fn(r) ) )
print("right:", h*G *  ZZ( 1 / Fn(r) ) )
print("r inv:", ZZ( 1 / Fn(r) ))

print("u1", s *  ZZ( 1 / Fn(r) ))
print("u2", (- h * ZZ( 1 / Fn(r) )) % n)

u1G = (- h *  ZZ( 1 / Fn(r) )) * G
print("u1 G x", str(Q.xy()[0]))
print("u1 G y", str(Q.xy()[1]))

# RESULT:
print('And here is the pubkey for which this signature will validate:')
print('x coordinate: ' + str(Q.xy()[0]))
print('y coordinate: ' + str(Q.xy()[1]))
print()
print('Voila.. :-)')
print()
