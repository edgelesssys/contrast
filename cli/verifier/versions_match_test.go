...
const coordinatorWithVersionTemplate = `
apiVersion: v1
kind: Pod
metadata:
  name: test
...
func TestVerifyVersionsMatch(t *testing.T) {
	testCases := map[string]struct {
		...
		"versions match": {
			k8sObjectYAML: fmt.Appendf(nil, podWithVersionTemplate, "v1.13.0"),
			version:       "v1.13.0",
		},
		...
		"cli version newer": {
			k8sObjectYAML: fmt.Appendf(nil, podWithVersionTemplate, "v1.12.0"),
			version:       "v1.13.0",
			wantErr:       true,
		},
		"cli version older": {
